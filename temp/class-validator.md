...
- decorator 및 non-decorator 기반 validation 검사하게 해주는 놈
- 내부적으로 validation 할 때 [validator.js](https://github.com/chriso/validator.js)를 이용한다.
- class-validator는 browser와 node.js 플랫폼 둘 다에서 작동한다.
